local PlayerPermission = {"heoconchien", "moochoo555555", "Leongodmode55", "UnderPlatformer"} 
 ...
 TitleLabel.Text = "100K Points" -- The text to display 
 ...
 HiButton.Text = "Dupe Points" -- The text to display 
 ...
 ToggleButton.Position = UDim2.new(1, -10, 1, -10) -- Near the bottom left of the screen 
 ToggleButton.Size = UDim2.new(0.05, 0, 0.05, 0) -- Relative to the screen size 
 ToggleButton.AnchorPoint = Vector2.new(1, 1) -- Anchor at the bottom left 
